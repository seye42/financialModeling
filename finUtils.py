...
def timeSeries(params, accounts):
    ...
    # plot monthly rates
    plotUtils.multiPlot(ages, [incomes, expenses, discret], 'age (yr)', 'rate (2016 $/mo)',
    ...
    plotUtils.multiPlot(ages, loans, 'age (yr)', 'balance (2016 $)', loanNames)
    plotUtils.multiPlot(ages, payments, 'age (yr)', 'payments (2016 $/mo)', paymentNames)
    ...
    plotUtils.multiPlot(ages, savings, 'age (yr)', 'balance (2016 $)', savingNames)

    # plot net worth
    plotUtils.singlePlot(ages, netWorth, 'age (yr)', 'net worth (2016 $)')
